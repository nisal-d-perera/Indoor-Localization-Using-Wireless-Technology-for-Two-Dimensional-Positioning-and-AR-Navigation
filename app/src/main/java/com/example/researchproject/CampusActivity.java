...
public class CampusActivity extends AppCompatActivity {
    private final String FLOOR1_WIFI = "Research_LAB";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        localizeBtn.setOnClickListener(v -> {
            if (currentFloor == null || currentFloor.isEmpty()) {
                Toast.makeText(CampusActivity.this, "Floor not detected yet", Toast.LENGTH_SHORT).show();
                return;
            }

            Intent intent = new Intent(CampusActivity.this, LocalizeActivity.class);
            intent.putExtra("locationType", "campus");
    ...
    private void checkFloorBasedOnWifi() {
        ...
        if (detectedFloor != null && !detectedFloor.equals(currentFloor)) {
            ...
            if (detectedFloor.equals("1st Floor")) {
                floorImage.setImageResource(R.drawable.r_lab); // Floor-1.png → floor_1.png
            } else {
                floorImage.setImageResource(R.drawable.lab01); // Floor-2.png → floor_2.png
            }
        }
    }
